          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                A society devoid of{' '}
                <span className="text-white">poverty and social deprivation</span>
              </h1>
          ...
          <div className="relative animate-slide-up">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-brand-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-black">Humanitarian Aid</p>
                  <p className="text-sm text-black">Supporting communities</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-brand-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-black">Community Impact</p>
                  <p className="text-sm text-black">Empowering lives</p>
                </div>
              </div>
            </div>
          </div>
