...
const Programs: React.FC = () => {
  const getProgramIcon = (title: string) => {
    const iconMap: { [key: string]: React.JSX.Element } = {
      ...
      'Climate Change': (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4m9 0a4 4 0 00-4-4m-9 0a4 4 0 014-4m9 0a4 4 0 00-4 4m-9 0a4 4 0 014-4m9 0a4 4 0 00-4 4m-9 0a4 4 0 014-4m9 0a4 4 0 00-4 4" />
        </svg>
      )
    };
