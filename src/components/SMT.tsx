...
//             <div 
//               key={member.id}
//               className="card p-8 text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in"
...
//               mx-auto mb-6 group-hover:scale-105 transition-transform duration-300 shadow-lg">
//                 {member.initials}
//               </div>
